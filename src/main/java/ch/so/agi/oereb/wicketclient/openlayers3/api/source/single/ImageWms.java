package ch.so.agi.oereb.wicketclient.openlayers3.api.source.single;
...
public class ImageWms extends JavascriptObject implements Serializable {
     ...
     *         Parameters for this tile map data source
     */
    public ImageWms(String url, Map<String, String> params) {
        super();
     ...
     */
    public ImageWms url(String url) {
        setUrl(url);
        return this;
    }
     ...
     * @return This instance
     */
    public ImageWms params(Map<String, String> params) {
        setParams(params);
        return this;
    }    
     ...
     * @return This instance
     */
    public ImageWms serverType(ServerType serverType) {
     ...
     * @return This instance
     */
    public ImageWms projection(Projection projection) {
